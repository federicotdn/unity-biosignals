...
def main():
  with open('/Users/hobbit/projects/ProyectoFinal/DataSets/EMG/javier-1.emg.csv', 'r') as csvfile:
  ...
  ax1.scatter(x_o, y_o, c='b', marker="x", label='Tenso')
  ax1.scatter(x_c, y_c, c='r', marker="o", label='Relajado')
  plt.xlabel('PSD')
  plt.ylabel('PSD')
