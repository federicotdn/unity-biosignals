...
Utilizando estos criterios, se eligieron las siguientes señales: \acrshort{emg}, \acrshort{emg} y \acrshort{spo2}. Todas ellas cumplen con la condición de ser prácticas y no invasivas, lo suficientemente dinámicas para que sean aplicables en nuestro estudio, que el tiempo de procesado sea apto para el tiempo real, y que los sensores fueron accesibles y comerciales como para poder probarlos e implementarlos.
